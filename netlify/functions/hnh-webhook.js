...
- Never repeat customer emails, user IDs or licence keys. They are not in your data and should not be invented.

Style: Lewis is on a phone. Two or three sentences usually. No headers or bullets unless comparing several things. Direct, plain UK English, no preamble.
...
export default async (req) => {
  ...
  try {
    ...
    await tg('sendMessage', { chat_id: chatId, parse_mode: 'HTML', text: esc(answer) });
  } catch (err) {
