...
async function buildContext() {
  ...
  // 90 days for performance trends, separate from the 14-day pipeline view.
  const events90 = await readEventRange(addDays(today, -89), today);
  ...
  return {
    ...
    marketing: {
      ...
      history: contentHistory(recentEvents),
      performance: contentPerformance(events90),
      playbook: PLATFORM_PLAYBOOK,
      algorithms: ALGORITHM_PLAYBOOK,
    },
  };
}
