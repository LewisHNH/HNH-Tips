...
import { WHOP_URL, TELEGRAM_URL, GROUP_PRICE } from './config.js';
  ...
  return (
    <section className="ghg" id="greyhounds">
      ...
      <header className="ghg-head">
        ...
        <h2 className="ghg-title">GREYHOUNDS</h2>
      ...
      {months.length > 0 && (
        <div className="ghg-group">
          ...
          <p className="ghg-group-note">
            Settled to advised prices, same as the free record above. Past results are not a guide to future returns.
          </p>
        </div>
      )}
      ...
      <a className="ghg-upgrade" href={WHOP_URL} target="_blank" rel="noopener noreferrer">
        ...
        <span className="ghg-upgrade-line">Every selection, every meeting — {GROUP_PRICE}</span>
      </a>
...
.ghg{padding:0;}
.ghg-head{text-align:center;margin-bottom:20px}
...
.ghg-upgrade-line{display:block;font-size:14px;font-weight:700;margin-top:7px;letter-spacing:.04em}
