...
function Logo() {
  ...
  if (broken) return (
    <div className="lockup"><div className="w1">Horses</div><div className="w2">By HNH</div></div>
  );
  return <img className="logo" src={LOGO_SRC} alt="Horses by HNH" onError={() => setBroken(true)} />;
}
